...
- Route planning, editing, and review through `docs/ai/project-context.md`, `docs/ai/workflow.md`, and `docs/ai/approval-boundaries.md` before mutation.
- Keep approval, generated artifact, and security guidance aligned with `docs/ai/approval-boundaries.md`, `docs/ai/generated-artifacts.md`, `docs/ai/AI-GUARDRAILS.md`, and `SECURITY.md`.
...
- For VS Code surfaces, recommend workspace settings based on `docs/ai/copilot-tooling.md` so terminal auto-approval and sandbox rules reinforce the same boundary when a VS Code settings file is present.
