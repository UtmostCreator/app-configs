---
applyTo: '.chezmoiroot,.editorconfig,.eslintrc.json,.gitattributes,.gitignore,.lefthook.yml,.opencode,.prettierrc.json,.repomixignore,.stylelintrc.json,AGENTS.md,CONTRIBUTING.md,PLACEHOLDERS.md,README.md,SECURITY.md,SUPPORT.md,home,llms.txt,mise.toml,nix,ops,reference,repo-docs,tests'
