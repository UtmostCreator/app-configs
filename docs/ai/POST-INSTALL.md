...
- Packs: `capabilities-extended-full, hooks-pack, ci-pack, docs-reference-pack, delivery-pack, optional-agents-opencode-pack, preview-environments-pack, evaluation-pack, service-boundary-pack, mcp-boundaries-pack, advisor-pack, target-tools-pack, shared-templates-pack, package-source-pack, scripts-pack, policy-pack, evidence-pack, adapter-opencode, capabilities-extended-lite, base, setup-docs, capabilities-core`
