...
| `github-copilot-instruction` | ci | `.github/instructions/ci.instructions.md` | CI and YAML investigation routing |
...
| `github-copilot-instruction` | frontend | `.github/instructions/frontend.instructions.md` | Frontend investigation and verification routing |
