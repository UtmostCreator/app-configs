...
- `scripts/copilot/fd-files.sh`
- `scripts/copilot/gh-pr-context.sh`
- `scripts/copilot/git-forensics.sh`
- `scripts/copilot/pack-context.sh`
- `scripts/copilot/post-tool-use.sh`
- `scripts/copilot/pre-tool-use.sh`
- `scripts/copilot/preview-file.sh`
- `scripts/copilot/query-usage.sh`
- `scripts/copilot/repomix-context-tree.sh`
- `scripts/copilot/repomix-scc-router.sh`
- `scripts/copilot/rg-code.sh`
- `scripts/copilot/run-repomix-context.sh`
- `scripts/copilot/watch-loop.sh`
