...
- Commit: `92d5dbc`
- Branch: `main`
- Recommended next action: `Resume work from next_action and current verify/risk posture.`
...
```json
{
    ...
    "command": "php tools/ai/ai.php session-resume",
    ...
    "score": null,
    "stale": false,
    "recommended_next_action": "Resume work from next_action and current verify/risk posture.",
    "data": {
        "snapshot": {
            "branch": "main",
            "commit": "92d5dbc",
