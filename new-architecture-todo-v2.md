...
WSL2 caveats (documented in `docs/bootstrap.md`):
...
## Commit
```bash
git add docs/migration-source-of-truth.md  # if you want the audit in git
...
- [ ] Cross-reference `docs/software-and-cli-tools.md`
...
## Commit
```bash
git add docs/migration-package-ownership.md
...
## Pre-flight checks
- [ ] `nix --version` ≥ 2.18
- [ ] `docs/migration-package-ownership.md` complete
...
# Keep docs/install-dev-tools.sh as a legacy/macOS reference unless deletion is approved later.
...
### `docs/architecture/tool-ownership.md`
...
- [ ] `docs/shell-setup.md` — chezmoi paths
- [ ] `docs/nvim-setup.md` — chezmoi paths
- [ ] `docs/software-and-cli-tools.md` — refer to matrix
- [ ] `docs/vscode-extensions.md` — note manual install or future `mise run sync` extension
- [ ] `docs/keyboard.md` — karabiner via chezmoi (macOS-gated)
