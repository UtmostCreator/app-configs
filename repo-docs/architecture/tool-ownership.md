...
Companion to `repo-docs/migration-implementation-plan.md`. Companion audit docs:
`repo-docs/migration-source-of-truth.md`, `repo-docs/migration-package-ownership.md`,
