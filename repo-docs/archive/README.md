...
| `migration-package-ownership.draft.md` | Regenerable draft from `scripts/generate-package-matrix.sh`. |
| `migration-source-of-truth.draft.md` | Regenerable draft from `scripts/check-source-of-truth.sh`. |
...
`migration-followups.md` (referenced by `scripts/doctor.sh`,
`scripts/validate-config.sh`, the README, and `architecture/tool-ownership.md`).
