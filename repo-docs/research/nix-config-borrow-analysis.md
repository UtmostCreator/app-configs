...
**Cost:** ~120 lines of Nix + a doc paragraph in `repo-docs/architecture/tool-ownership.md`. No changes to chezmoi or bootstrap.
...
**When:** as soon as we have a real "the laptop needs this token" use case. Today we explicitly defer secrets handling in `repo-docs/architecture/tool-ownership.md`.
