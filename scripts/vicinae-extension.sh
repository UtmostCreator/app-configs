...
#
# Usage:
#   bash scripts/vicinae-extension.sh <extension-dir-name>
#   bash scripts/vicinae-extension.sh visual-studio-code-recent-projects
#   bash scripts/vicinae-extension.sh <name> --build      # production build, no watch
#   VICINAE_EXT_CACHE=~/code/raycast bash scripts/vicinae-extension.sh <name>
#
# List candidates:
#   bash scripts/vicinae-extension.sh --list | grep -i code
#
