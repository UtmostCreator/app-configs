...
$ok = aiCompareOrWrite($root, 'AI-universal-rules/catalog.json', $json, $checkOnly, $messages) && $ok;
$ok = aiCompareOrWrite($root, 'docs/ai/catalog.md', aiRenderRootCatalogMarkdown($catalog), $checkOnly, $messages) && $ok;
$ok = aiCompareOrWrite($root, 'AI-universal-rules/docs/BROWSE.md', aiRenderBrowseMarkdown($catalog), $checkOnly, $messages) && $ok;
